...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x3b06c8)) ;
...
extern "C" {
	...
	extern void subprog_m_1a2a7d386067a6cb_556ead11_2117(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 412808, 168, 130592) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_1a2a7d386067a6cb_556ead11_2117), IP) ;
